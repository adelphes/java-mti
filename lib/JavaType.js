...
class CompiledJavaType extends CEIJavaType {
    ...
    constructor(decoded, typemap, typeargs) {
        ...
        if (sigattr) {
            ...
            super.typeVariables = typeargs || typevars;
    ...
    specialise(types) {
        ...
        // @ts-ignore
        const typeargs = this.typeVariables.map((tv, idx) => new TypeArgument(tv, types[idx] || this._typemap.get('java/lang/Object')));
